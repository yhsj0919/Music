...
public class PlayButton extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRadius = typeArray.getDimension(R.styleable.PlayButton_radius, 300);
        mStrokeWidth = typeArray.getDimension(R.styleable.PlayButton_strokeWidth, 20);
        ...
        mTextColor = typeArray.getColor(R.styleable.PlayButton_textColor, Color.WHITE);
    ...
    private void initVariable() {
        ...
        mTextPaint.setColor(mBigCircleColor);
